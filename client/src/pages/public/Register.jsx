...
import { Mail, Lock, User, Eye, EyeOff, ArrowRight, Briefcase, CheckCircle2, Star, Shield, Zap } from 'lucide-react';
  ...
  return (
    <>
      ...
      >
        ...
        />
        {/* Gradient overlay — heavier on right this time (mirrored from Login) */}
        ...
        <div className="relative z-10 flex flex-col md:flex-row w-full min-h-screen">
          ...
          {/* ════ LEFT SIDE — Form panel (slides in from left) ════ */}
          <div className="slide-in-left flex items-center justify-center md:justify-start px-6 pt-10 pb-6 md:pt-0 md:pb-0 md:pl-50 md:w-[45%]">
            <div className="w-full max-w-[370px] bg-white rounded-3xl shadow-2xl shadow-black/30 overflow-hidden">
              ...
              <div className="bg-gradient-to-r from-slate-900 to-slate-800 px-7 py-5">
                <div className="flex items-center gap-2.5 mb-3">
                  ...
                  {/* <span className="text-white/70 text-sm font-medium">JobPortal</span> */}
                </div>
              ...
              <div className="px-7 py-7 fade-up">
                ...
                <label className="flex items-start gap-2 mb-5 cursor-pointer">
                  <input type="checkbox" required className="mt-0.5 rounded accent-slate-900 w-3 h-3 flex-shrink-0" />
                  <span className="text-[11px] text-slate-400 leading-relaxed">
                    I agree to the{' '}
                    <Link to="/terms" className="text-slate-700 font-semibold hover:underline">Terms of Service</Link>
                    {' '}and{' '}
                    <Link to="/privacy" className="text-slate-700 font-semibold hover:underline">Privacy Policy</Link>
                  </span>
                </label>
          ...
          <div className="slide-in-right flex flex-col justify-between px-8 pt-6 pb-10 md:px-16 md:py-16 md:w-[55%]">
            ...
            <div className="my-auto py-12 md:py-0 md:text-right md:pr-35">
              ...
              <p className="text-white/50 text-base font-light leading-relaxed max-w-md ml-auto mb-10">
                Over 2 million professionals trust JobPortal to find meaningful work.
                Join them today.
              </p>
              ...
              <div className="space-y-3 max-w-md ml-auto">
                {perks.map(({ icon: Icon, text, delay }) => (
                  <div
                    key={text}
                    className={`${delay} flex items-center gap-3 md:justify-end`}
                  >
